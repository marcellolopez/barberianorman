...
<head>
  ...
  <title>Login / Barbería Norman</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4 text-dark">¡Bienvenido!</h5>
                  ...
                  <form class="row g-3 needs-validation" action="{{url('admin/loginForm')}}" method="POST">
                    ...
                    <div class="col-12">
                      <button class="btn btn-outline-dark w-100" type="submit">Entrar</button>
                    </div>
                    @if($errors->any())
                      <div class="alert alert-danger text-center" role="alert">
                        <strong><i class="bi bi-exclamation-triangle"></i></strong> {{$errors->first()}}
                      </div>
                    ...
                    @endif
                    <div class="col-12 d-none">
                      <p class="small mb-0 text-center">¿Aún no tienes cuenta? <a href="pages-register.html">Ingresa aquí</a></p>
                    </div>
                  </form>
