...
<aside id="sidebar" class="sidebar">
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <li>
        <a href="/admin/index" class="{{$currentRoute == 'admin/index' ? 'active' : ''}} text-black">
          <i class="bi bi-circle"></i><span>Inicio</span>
        </a>
      </li>
      <li>
        <a href="/admin/agenda" class="{{$currentRoute == 'admin/agenda' ? 'active' : ''}} text-black">
          <i class="bi bi-circle"></i><span>Agendar</span>
        </a>
      </li>
      <li>
        <a href="/admin/registros" class="{{$currentRoute == 'admin/registros' ? 'active' : ''}} text-black">
          <i class="bi bi-circle"></i><span>Registros</span>
        </a>
      </li>
      <li>
        <a href="/admin/reportes" class="{{$currentRoute == 'admin/reporte' ? 'active' : ''}} text-black">
          <i class="bi bi-circle"></i><span>Reportes</span>
        </a>
      </li>
      <li>
        <a href="/admin/logout" class="{{$currentRoute == 'admin/logout' ? 'active' : ''}} text-black">
          <i class="bi bi-circle"></i><span>Salir</span>
        </a>
      </li>
